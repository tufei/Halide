...
if(NOT JCTVC)
    ...
    set(HEVC_LIBRARIES ${X265_8BIT} ${X265_10BIT} ${X265_12BIT})
else()
    set(HEVC_LIBRARIES ${JCTVC})
endif()

include(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(BPG DEFAULT_MSG HEVC_LIBRARIES BPG_ENC_LIBRARY BPG_DEC_LIBRARY BPG_INCLUDE_DIR)
