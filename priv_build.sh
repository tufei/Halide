...
cd apps
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_MODULE_PATH=~/.local/git/Halide/cmake/Modules -DCMAKE_PREFIX_PATH=~/Source/halide_build/_Halide_install ~/.local/git/Halide/apps
